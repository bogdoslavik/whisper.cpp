...
extern "C" {
    ...
    // Return number of hypotheses generated by the last decoding call
    WHISPER_API int whisper_full_n_hypotheses(struct whisper_context * ctx);
    WHISPER_API int whisper_full_n_hypotheses_from_state(struct whisper_state * state);

    // Access hypothesis text and score ordered by likelihood (0 - best)
    WHISPER_API const char * whisper_full_get_hypothesis_text           (struct whisper_context * ctx, int i_hypothesis);
    WHISPER_API const char * whisper_full_get_hypothesis_text_from_state(struct whisper_state * state, int i_hypothesis);
    WHISPER_API float        whisper_full_get_hypothesis_score          (struct whisper_context * ctx, int i_hypothesis);
    WHISPER_API float        whisper_full_get_hypothesis_score_from_state(struct whisper_state * state, int i_hypothesis);
#ifdef __cplusplus
}
#endif
